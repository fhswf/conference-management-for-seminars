...
function SeminarAdminPage() {
    ...
    const {data} = useFetch<Seminar[]>(`${import.meta.env.VITE_BACKEND_PROTOCOL}://${import.meta.env.VITE_BACKEND_URL}/seminar/get-seminars`);
    ...
    async function onCreateSeminar() {
        ...
        const result = await fetch(`${import.meta.env.VITE_BACKEND_PROTOCOL}://${import.meta.env.VITE_BACKEND_URL}/seminar/seminar`, {
            method: "POST",
            credentials: 'include',
            headers: {
